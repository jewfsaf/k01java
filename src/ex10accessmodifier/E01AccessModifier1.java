...
/*
class를 정으할대는 반드시 public이나 default(생략형)만
사용해야한다
 */
...
public class E01AccessModifier1 {
	...
	//멤버변수를 각의 접근지정자를 통해 선언한다.
	private int privateVar;
	int defaultVar;
	public int publicVar; 

	//멤버메서드도 각각의 접근 지정자를 통해 선언한다.
	/*
	동일 클래스 내에서는private 멤버라 할지라도 접근이 가능하다.
	...
	/*
	private으로 선언된 멤버 (변수 혹은 메서드)를 외부 클래스에서 접근하고
	싶을때는 public으로 선언된 멤버메서드를 이용해서 간접적으로 접근해야 한다.
	 */
