...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		중복저장
			...
			add() 메서드는 추가에 성공한 겨우 true를 반환한다.
		 */
		...
		1. 컬렉션에 저장된 내용을 Iterator에게 알려주기 위해 객체를
			생성한다.
		2.hasNext()로 반환할 객체가 있는지 확인하고, next()객체를
			반환한다.
		3.모든객체가 반환되었다면 jasNext()는 false을 반환한다.
		 */
		System.out.println("\n[반복자(Iterator) 사용]");
		...
		/*
		방법2 : index()메서드로 인덱스를 확인한 후 삭제한다.
