...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println("str1의 두번쨰 문자:"+ str1.charAt(1)); 
		System.out.println("str2의 두번쨰 문자:"+ str2.charAt(1)); 
		 ...
		 */
		System.out.println("##### endWith(), startsWith() #####");
		System.out.println("www.daum.net".endsWith("net"));
		System.out.println("naver.com".startsWith("http"));
		
		/*
		9]format()
			: 출력형식을 지정하여 문자열로 반환하고 싶을대 사용한다.
			printf()와 사용법은 동일하고, 주로 웹플리케이션(JSP)을
			제잘할때 주로 사용된다.
		 */
		...
		11] lastImdexOf()
			...
			찾는것이 다르다.
		 */
		System.out.println("##### lastImdexOf() #####");
		...
		/*
		13] split()
			: 문자열을 구분자를 통해 분리해서 String탑입의 배열로
		...
		15] codePointAt(인덱스)
			...
			아스키코드(유니코드)를 반환한다. 
		 */
		System.out.println("##### codePointAt(인덱스) #####");
