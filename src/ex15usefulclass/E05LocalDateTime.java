...
public class E05LocalDateTime {
	...
	public static void main(String[] args) {
		...
		DateTimeFormatter format2 = 
				DateTimeFormatter.ofPattern("HH시mm분ss초");
		DateTimeFormatter format3 = 
				DateTimeFormatter.ofPattern("오늘은 yyyy년의 w주차, D번째날");
		...
		/*
		ChronoUnit 클래스 : 특정 시간 단위로 차이를 구한
		 */
		...
		System.out.println("오늘 : "+ localDateTime.plusDays(1));
	}
}
