...
/*
for문 : while문과 같은 반복문을 초기값, 조건식, 증감식이
...
public class E05For {
	...
	public static void main(String[] args) {
		...
		System.out.println("1~10사이2의배수의합(방법2)"+ total);
...
//		}
		...
		라고한다. 지역변수는 해당 지역을 벗어난면 즉시 소멸되는 특징을
		가지고있다.
		 */
