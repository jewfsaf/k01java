...
class FruitSeller{
	...
	/*
	클래스의 멤버상수를 선언하는경우 반드시 선언과 동시에
	초기화를 해야한다. 만약 초기화를 별도로 진행한다면 에러가
	발생하게된다.
	 */
	...
	1. 구매자로부터 금약을 전달받는다.(매개변수)
	2. 금액/사과의단가=판매퇼 사과의 갯수를 구한다.(5000/1000=5)
...
public class E06FruitSalesMain1
{
	public static void main(String[] args)
	{
		...
		FruitBunyer buyer = new FruitBunyer();//구매자 객체
