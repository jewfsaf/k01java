...
멤버변수의 이름마능로 접근이 간으하다.
단, 클래스 외부에서 접근할 경우 객체생성없이 클래스명을 통해서도
접근할 수 있다. 즉 static이 가진 기본적인 규칙을 딸느다. 
 */
class Adder{
	...
	/*
	static으로 선언된 멤버변수는 실제로는 외부(메서드영역)에 생서되어 
...
public class E03StaticInheritance {
	...
	public static void main(String[] args) {
		...
		/*
		멤버변수가 val은 static 이므로 프로그램 시작시 하나만
		생성되어 메서드영역에 로드된다.
		 */
		Adder ad = new Adder();
