...
//컴퓨터 : 기본적인 커퓨팅 환경을 제공하여 입력된 내용을 계산한다.
class Computer{
	//소유주를 표현한 멤버변수
	String owner;
	...
	간접 호출해야 한다.
	상속관계라면 protectde로 선언된 메서드로 호출할수도 있다.
	 */
...
class TabletNotebook extends NotebookComputer{
	...
	public void write(String penInfo) {
		...
		/*
		A.compareTo(B)
			: 문자열 A와 B를 비교하여 0이 반환되면 같은 무자열로
			판단하고, -1이나 1이 반환되면 서로 다른 무자열로 판단하는
			String 클래스에 정의된 메서드.
		 */
...
public class E04ISAInheritance {
	...
	public static void main(String[] args) {
		...
		TabletNotebook tablet = new TabletNotebook("이동우", 5, "ISE-1234");
		...
		System.out.println("==ISE-1234 펜으로 테플릿사용==");
		tablet.write("ISE-1234");//정상사용

		System.out.println("==XYZ-9876 펜으로 테플릿사용==");
