...
class FriendInfoHandler {
	...
	public void addFriend(int choice) {
		...
		3. numOfFriends를 1 증가시킨다. 휘위증가이므로 이렇게 처리된다.
		 */
	...
	public void deleteInfo() {
		...
		if(deleteIndex==-1) {
			...
			요소를 앞으로 하나씩 이동시킨다.
			numOfFriend는 앞에서 1 차감되므로 마지막요소는 무시된다.
			 */
			for(int i=deleteIndex ; i<this.numOfFriends ; i++) {
...
/*
포르그램 전반의 흐름에 대해서만 기술하고 관련 메서드를
호출하는 정도로만 구성한다. main메서드는 단지 프로그램의
시작점(Entry point) 정도의 의만 가지는게 좋다. 
 */
